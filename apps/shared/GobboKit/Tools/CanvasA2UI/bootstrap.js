...
import "@a2ui/lit/ui";
import { themeContext } from "@gobbo/a2ui-theme-context";
...
class GobboA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--gobbo-a2ui-inset-top, 0px)
        var(--gobbo-a2ui-inset-right, 0px)
        var(--gobbo-a2ui-inset-bottom, 0px)
        var(--gobbo-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--gobbo-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--gobbo-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--gobbo-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--gobbo-a2ui-empty-top, var(--gobbo-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("gobbo:a2ui-action-status", this.#statusListener);
    this.#syncSurfaces();
  }
  ...
  disconnectedCallback() {
    ...
    if (this.#statusListener) {
      globalThis.removeEventListener("gobbo:a2ui-action-status", this.#statusListener);
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__gobboLastA2UIAction = userAction;

    const handler =
      globalThis.webkit?.messageHandlers?.gobboCanvasA2UIAction ??
      globalThis.gobboCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        // WebKit message handlers support structured objects; Android's JS interface expects strings.
        if (handler === globalThis.gobboCanvasA2UIAction) {
...
customElements.define("gobbo-a2ui-host", GobboA2UIHost);
