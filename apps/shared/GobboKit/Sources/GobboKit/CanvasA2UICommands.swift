...
public enum GobboCanvasA2UICommand: String, Codable, Sendable {
...
public struct GobboCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct GobboCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
