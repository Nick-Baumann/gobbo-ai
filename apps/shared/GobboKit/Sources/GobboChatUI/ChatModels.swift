...
public typealias GobboPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias GobboPlatformImage = UIImage
#endif

public struct GobboChatUsageCost: Codable, Hashable, Sendable {
...
public struct GobboChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: GobboChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(GobboChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct GobboChatMessageContent: Codable, Hashable, Sendable {
...
public struct GobboChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [GobboChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: GobboChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [GobboChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: GobboChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(GobboChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([GobboChatMessageContent].self, forKey: .content) {
...
public struct GobboChatHistoryPayload: Codable, Sendable {
...
public struct GobboChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct GobboChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct GobboAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct GobboChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct GobboGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct GobboPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: GobboPlatformImage?
...
public struct GobboChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
