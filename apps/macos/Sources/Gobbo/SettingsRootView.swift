...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .gobboSelectSettingsTab)) { note in
...
extension Notification.Name {
    static let gobboSelectSettingsTab = Notification.Name("gobboSelectSettingsTab")
}
