...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Gobbo/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__gobbo__/a2ui/").absoluteString + "?platform=macos"
    }
