...
/// Menu contents for the Gobbo menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Toggle(
                isOn: Binding(
                    ...
                    set: { enabled in
                        ...
                        GobboConfigFile.setBrowserControlEnabled(enabled)
                    })) {
            ...
            self.debugMenu
            Button("About Gobbo") { self.open(tab: .about) }
        ...
        .onAppear {
            self.browserControlEnabled = GobboConfigFile.browserControlEnabled()
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        self.openSettings()
        NotificationCenter.default.post(name: .gobboSelectSettingsTab, object: tab)
    }
