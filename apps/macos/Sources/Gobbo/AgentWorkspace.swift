...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return GobboConfigFile.defaultWorkspaceURL() }
