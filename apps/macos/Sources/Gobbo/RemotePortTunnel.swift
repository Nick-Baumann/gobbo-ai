...
final class RemotePortTunnel {
    private static let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "remote.tunnel")
    ...
    private static func findPort(preferred: UInt16?) async throws -> UInt16 {
        ...
        return try await withCheckedThrowingContinuation { cont in
            let queue = DispatchQueue(label: "com.nickbaumann.gobbo.remote.tunnel.port", qos: .utility)
            do {
