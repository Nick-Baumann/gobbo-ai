...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Gobbo token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: GobboOAuthStore.AnthropicOAuthStatus = GobboOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "anthropic-oauth")
...
enum GobboOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let gobboOAuthDirEnv = "GOBBO_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Gobbo OAuth token file not found"
            case .unreadableFile: "Gobbo OAuth token file not readable"
            case .invalidJSON: "Gobbo OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Gobbo OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Gobbo OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.gobboOAuthDirEnv]?
        ...
        return FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".gobbo", isDirectory: true)
