...
private let gatewayConnectionLogger = Logger(subsystem: "com.nickbaumann.gobbo", category: "gateway.connection")
...
extension GatewayConnection {
    ...
    func healthOK(timeoutMs: Int = 8000) async throws -> Bool {
        ...
        return (try? self.decoder.decode(GobboGatewayHealthOK.self, from: data))?.ok ?? true
    }
    ...
    func chatHistory(sessionKey: String) async throws -> GobboChatHistoryPayload {
    ...
    func chatSend(
        ...
        attachments: [GobboChatAttachmentPayload],
        timeoutMs: Int = 30000) async throws -> GobboChatSendResponse
    {
        var params: [String: AnyCodable] = [
