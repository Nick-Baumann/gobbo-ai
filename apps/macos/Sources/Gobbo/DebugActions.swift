...
enum DebugActions {
    private static let verboseDefaultsKey = "gobbo.debug.verboseMain"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Gobbo", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".gobbo/gobbo.json")
        guard
