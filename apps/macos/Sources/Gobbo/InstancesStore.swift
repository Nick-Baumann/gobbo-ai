...
final class InstancesStore {
    ...
    private let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "instances")
    ...
    func handlePresenceEventPayload(_ payload: GobboProtocol.AnyCodable) {
        do {
...
extension InstancesStore {
    static func preview(instances: [InstanceInfo] = [
        InstanceInfo(
            ...
            mode: "local",
            reason: "preview",
            text: "Local node: nickbaumann-mac (10.0.0.12) · app 1.2.3",
