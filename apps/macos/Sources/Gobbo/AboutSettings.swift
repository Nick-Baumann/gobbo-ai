...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/nickbaumann/gobbo") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/nickbaumann/gobbo")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://nickbaumann.me")
                AboutLinkRow(icon: "bird", title: "Twitter", url: "https://twitter.com/nickbaumann")
                AboutLinkRow(icon: "envelope", title: "Email", url: "mailto:peter@nickbaumann.me")
            }
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "GobboBuildTimestamp") as? String else { return nil }
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "GobboGitCommit") as? String ?? "unknown"
    }
