...
final class ControlChannel {
    ...
    private let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "control")
    ...
    private func friendlyGatewayMessage(_ error: Error) -> String {
           ...
           urlErr.code == .dataNotAllowed // used for WS close 1008 auth failures
        {
            ...
            return
                "Gateway rejected token; set GOBBO_GATEWAY_TOKEN in the mac app environment " +
...
extension Notification.Name {
    static let controlHeartbeat = Notification.Name("gobbo.control.heartbeat")
    static let controlAgentEvent = Notification.Name("gobbo.control.agent")
}
