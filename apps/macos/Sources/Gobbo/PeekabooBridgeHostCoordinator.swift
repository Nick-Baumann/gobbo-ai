...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: GobboPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = GobboPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.gobboSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.gobboSocketPath, privacy: .public)")
    }
}

@MainActor
private final class GobboPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.nickbaumann.gobbo.peekaboo")
