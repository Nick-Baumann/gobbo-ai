...
enum RuntimeLocator {
    private static let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "runtime")
    ...
    static func describeFailure(_ error: RuntimeResolutionError) -> String {
        ...
        case let .notFound(searchPaths):
            [
                "gobbo needs Node >=22.0.0 but found no runtime.",
