        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading, spacing: 18) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    SettingsToggleRow(
                        title: "Gobbo active",
                        subtitle: "Pause to stop the Gobbo gateway; no messages will be processed.",
                    ...
                    SettingsToggleRow(
                        ...
                        subtitle: "Automatically start Gobbo after you sign in.",
                        binding: self.$state.launchAtLogin)

                    SettingsToggleRow(
                        title: "Show Dock icon",
                        subtitle: "Keep Gobbo visible in the Dock instead of menu-bar-only mode.",
                ...
                HStack {
                    Spacer()
                    Button("Quit Gobbo") { NSApp.terminate(nil) }
    ...
    private var cliInstaller: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if let status = cliStatus {
                ...
                Text("Symlink \"gobbo\" into /usr/local/bin and /opt/homebrew/bin for scripts.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                    .lineLimit(2)
            }
...
extension GeneralSettings {
    ...
    private func revealLogs() {
        ...
        Looked for gobbo logs in /tmp/gobbo/.
...
extension GeneralSettings {
    static func exerciseForTesting() {
        ...
        state.remoteProjectRoot = "/tmp/gobbo"
        state.remoteCliPath = "/tmp/gobbo"
        ...
        view.cliInstallLocation = "/usr/local/bin/gobbo"
