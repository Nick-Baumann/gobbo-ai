...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Gobbo windows, but below the system’s pop-up menus.
