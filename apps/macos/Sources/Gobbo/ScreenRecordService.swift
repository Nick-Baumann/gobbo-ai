...
final class ScreenRecordService {
    ...
    private let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "screenRecord")
        ...
        outPath: String?) async throws -> (path: String, hasAudio: Bool)
    {
        ...
        let outURL: URL = {
            ...
            return FileManager.default.temporaryDirectory
                .appendingPathComponent("gobbo-screen-record-\(UUID().uuidString).mp4")
        }()
...
private final class StreamRecorder: NSObject, SCStreamOutput, SCStreamDelegate, @unchecked Sendable {
    let queue = DispatchQueue(label: "com.nickbaumann.gobbo.screenRecord.writer")
