...
enum UIStrings {
    static let welcomeTitle = "Welcome to Gobbo"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: GobboOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: GobboChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "ln -sf '\(bundlePath)/Contents/Resources/Relay/gobbo' /usr/local/bin/gobbo"
    }
