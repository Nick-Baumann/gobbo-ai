...
actor GatewayEndpointStore {
    ...
    struct Deps: Sendable {
        ...
        static let live = Deps(
            ...
            token: { ProcessInfo.processInfo.environment["GOBBO_GATEWAY_TOKEN"] },
    ...
    private let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "gateway-endpoint")
    ...
    init(deps: Deps = .live) {
        ...
        if let modeRaw {
            ...
            let seen = UserDefaults.standard.bool(forKey: "gobbo.onboardingSeen")
