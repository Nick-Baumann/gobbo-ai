...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "com.nickbaumann.gobbo", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous Gobbo run already has an SSH listener on the expected port (common after restarts),
