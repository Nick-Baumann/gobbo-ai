...
struct LowCoverageHelperTests {
    ...
    @Test func gatewayLaunchAgentHelpers() {
        let keyBind = "GOBBO_GATEWAY_BIND"
        let keyToken = "GOBBO_GATEWAY_TOKEN"
        ...
        #expect(GatewayLaunchAgentManager._testGatewayExecutablePath(bundlePath: "/App") == "/App/Contents/Resources/Relay/gobbo")
