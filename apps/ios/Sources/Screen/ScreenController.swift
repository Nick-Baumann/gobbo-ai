...
final class ScreenController {
    ...
    /// Callback invoked when a gobbo:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = GobboKitResources.bundle
...
/// Handles navigation policy to intercept gobbo:// deep links from canvas
@MainActor
...
private final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    static let messageName = "gobboCanvasA2UIAction"
