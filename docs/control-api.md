...
**Deprecated (historical):** superseded by the WebSocket Gateway protocol (`gobbo gateway`, see `docs/architecture.md` and `docs/gateway.md`).
...
- `health`: returns the gateway health snapshot (same shape as `gobbo health --json`).
