---
summary: "Runbook: connect/pair the Android node to a Gobbo Gateway and use Canvas/Chat/Camera"
read_when:
...
```bash
gobbo nodes invoke --node "<Android Node>" --command canvas.navigate --params '{"url":"http://<gateway-hostname>.local:18793/__gobbo__/canvas/"}'
```
...
The A2UI host lives at `http://<gateway-host>:18793/__gobbo__/a2ui/`.
