...
export const A2UI_PATH = "/__gobbo__/a2ui";
export const CANVAS_HOST_PATH = "/__gobbo__/canvas";
export const CANVAS_WS_PATH = "/__gobbo/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.gobboCanvasA2UIAction.postMessage(...)
  // - Android: window.gobboCanvasA2UIAction.postMessage(...)
  const actionHandlerName = "gobboCanvasA2UIAction";
  ...
  globalThis.Gobbo = globalThis.Gobbo ?? {};
  globalThis.Gobbo.postMessage = postToNode;
  globalThis.Gobbo.sendUserAction = sendUserAction;
  globalThis.gobboPostMessage = postToNode;
  globalThis.gobboSendUserAction = sendUserAction;
